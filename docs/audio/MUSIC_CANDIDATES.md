...
> **[2026-08-19 갱신] 이 문서는 이제 "조사 기록" 입니다.**
> 실제로 실린 열 개 파일은 [`CREDITS.md`](./CREDITS.md) 에 있습니다.
> 이 문서의 결론 중 **지켜진 것**: CC0 만 쓴다 · 앰비언트는 남긴다 ·
> 아티팩트에는 안 박는다 · 음량을 다시 맞춘다(§7).
> **바뀐 것**: 출처가 OpenGameArt 가 아니라 **freesound.org(CC0)** 입니다 —
> 작업 환경에서 opengameart.org 로 나가는 길이 막혀 파일을 못 받았습니다.
> 곡도 넷이 아니라 **열** 이고, 자리도 여섯이 아니라 **일곱**(동아리 상점
> 포함)입니다. 아래 §5 의 후보표는 **한 곡도 안 썼습니다** — 라이선스는
> 여전히 유효하니, 다음에 opengameart 에 닿을 수 있는 곳에서 작업하면
> 그대로 1순위 후보입니다.
