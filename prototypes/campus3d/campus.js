...
export function buildCampus(scene) {
     ...
     길목(x 0 축)은 비웁니다. */
  {
    ...
    /* 가로등 넷 — 남북 축의 양옆(x ±14)에 두 줄만.
       길을 따라 늘어서야 가로등이고, 길 한복판이나 문 앞에 서면
       장애물입니다. 열둘을 세워 봤더니 광장이 기둥 숲이 됐습니다.

       동서 끝(x ±24)에도 넷을 세웠다가 뺐습니다. z 를 ±9 로 물려
       문 앞은 비켰지만, 도서관(x -29)·학생회관(x +29) 정면에서 보면
       현관과 기둥 사이에 가로등이 겹쳐 서서 **건물 앞을 가렸습니다.**
       광장 가로등은 광장 것이고, 건물 앞은 건물이 서는 자리입니다. */
    ...
    /* 자전거 거치대는 뺐습니다. 세워 둔 자전거는 아무도 타지 않고
       아무 데도 안 갑니다 — 캠퍼스처럼 보이라고 놓은 소품인데,
       광장에서 실제로 하는 일(앉기 · 말 걸기 · 들어가기) 과 아무
       관계가 없어 눈만 어지럽혔습니다. bikeRack() 은 남겨 둡니다. */
  }
