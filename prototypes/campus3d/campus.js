...
export function buildCampus(scene) {
  ...
  /* --- 광장 한가운데 --- */
  fountain(g, 0, 0, ctx);
  /* 2D 판의 캠퍼스 게시판 둘. 상호작용 좌표(spots.js)는 남아 있었는데
     모델만 광장 소품 정리 때 같이 빠져, 허공에서 E를 눌러야 했습니다.
     분수 북쪽 가장자리의 좌우에 세우고 판 앞면은 광장 쪽을 봅니다. */
  ...
  /* 광장 장식 소품 없음 — 벤치 · 가로등 · 화단 · 쓰레기통 · 이정표를
     전부 걷었습니다. 기능이 있는 게시판 둘만 위에 다시 세웠습니다.
     자리를 하나씩 손보는 것으로는 안 되는 단계입니다:
