export const RUNNER_CONFIG = Object.freeze({
  ...
  difficultyStages: Object.freeze([
    { untilMs: 20_000, speedMultiplier: 1 },
    { untilMs: 40_000, speedMultiplier: 1.12 },
    { untilMs: Infinity, speedMultiplier: 1.25 },
  ]),
})

export function createRunnerState() {
  return {
    status: 'READY', airborne: false, score: 0, coins: 0, hitCount: 0,
    combo: 0, maxCombo: 0, collectedCoins: new Set(), survivalScoreSeconds: 0,
    invincibleUntil: 0, startedAt: null, endedAt: null,
  }
}
