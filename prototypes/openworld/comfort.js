...
(function () {
  ...
  css.textContent = `
  /* ---- 대비 ----
     --ink-3 은 index.html 이 직접 잡습니다. 여기서 덮던 #7A6C66 은
     코랄 시절 값(#9A8E88, 2.99:1)을 고치려던 것이라 근거가 이미
     사실이 아니었고, 그 값 자체도 surface-3 위에서 4.45 로 미달이었습니다.
     지금은 셋(온보딩·월드·메인)이 같은 #656E6C 를 씁니다. */
