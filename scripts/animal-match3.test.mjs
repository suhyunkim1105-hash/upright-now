...
// 인자를 key 하나로 못 박으면 안 됩니다 — 이쪽 브랜치의 openPanel 은
// (key, tab) 이고 회고를 특정 탭으로 여는 데 tab 을 씁니다.
// 이 검사가 지키려는 것은 서명이 아니라 "openPanel 이 activePanelKey 를
// 채운다" 는 쪽이라, 뒤에 인자가 더 붙어도 통과하게 둡니다.
